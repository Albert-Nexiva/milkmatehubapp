...
class EditSupplierDetailsScreen extends StatefulWidget {
  final SupplierModel supplierModel;
  const EditSupplierDetailsScreen({super.key, required this.supplierModel});

  @override
  EditSupplierDetailsScreenState createState() =>
      EditSupplierDetailsScreenState();
}

class EditSupplierDetailsScreenState extends State<EditSupplierDetailsScreen> {
                    ...
                    onPressed: declared
                        ? () {
                            ...
                            if (_formKey.currentState!.validate()) {
                              ...
                              final supplierModel = SupplierModel(
                                type: widget.supplierModel.type,
                                uid: widget.supplierModel.uid,
                                ...
                                email: widget.supplierModel.email,
                              );

                              FirestoreDB()
                                  .editSupplier(supplierModel)
                                  .then((value) async {
                                setState(() {
                                  isLoading = false;
                                });
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                    content: Text('Supplier details updated'),
                                  ),
                                );
  ...
  @override
  void initState() {
    _nameController.text = widget.supplierModel.name;
    _phoneController.text = widget.supplierModel.phoneNumber;
    _addressController.text = widget.supplierModel.address;
    _cityController.text = widget.supplierModel.city;
    _cowCountController.text = widget.supplierModel.numberOfCows.toString();
    _experienceController.text =
        widget.supplierModel.experienceYears.toString();
    _bankAccountNumberController.text = widget.supplierModel.bank.accountNumber;
    _bankNameController.text = widget.supplierModel.bank.bankName;
    _bankBranchController.text = widget.supplierModel.bank.branch;
    _bankIFSCController.text = widget.supplierModel.bank.ifsc;
    _insuranceCoverageController.text = widget.supplierModel.insuranceCoverage;
    _cowList.addAll(widget.supplierModel.cows);
